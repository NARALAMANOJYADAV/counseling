...
urlpatterns = [
    ...
    path('inline-approve/', views.inline_approve, name='inline_approve'),
    path('student-search/', views.student_search_view, name='student_search'),
    path('admin-export/', views.admin_export_view, name='admin_export'),
    path('admin-bulk-manage/', views.admin_bulk_manage_view, name='admin_bulk_manage'),
